package com.michaelboss.newcoins.client.jei;

import com.michaelboss.newcoins.NewCoins;
import com.michaelboss.newcoins.recipe.BankCardPrintingMachineJeiRecipe;
...
public class BankCardPrintingMachineRecipeCategory implements IRecipeCategory<BankCardPrintingMachineJeiRecipe> {
    public static final RecipeType<BankCardPrintingMachineJeiRecipe> TYPE =
            RecipeType.create(NewCoins.MOD_ID, "bank_card_printing_machine", BankCardPrintingMachineJeiRecipe.class);
    ...
    public BankCardPrintingMachineRecipeCategory(IGuiHelper helper) {
        ResourceLocation guiTexture = NewCoins.id("textures/gui/bank_card_printing_machine.png");
